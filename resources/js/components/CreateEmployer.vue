            ...
            <form class="col s12" v-on:submit.prevent="onSubmit">
                <div class="row">
                    <div class="input-field col s6">
                        <input placeholder="Placeholder" id="first_name" v-model="employer.first_name" type="text"
                    ...
                    <div class="input-field col s6">
                        <input id="email" type="email" v-model="employer.email" class="validate">
                        <label for="email">Email</label>
                    </div>

                    <div class="input-field col s6">
                        <input id="phone" type="text" v-model="employer.phone" class="validate">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="employer_id" type="text" v-model="employer.employer_id" class="validate">
